  ...
  class MenuCard {
    ...
    render() {
      ...
      if (this.classes.length === 0) {
        ...
        this.classes.forEach(className => element.classList.add(className)) // Присваиваем классы в div 'element', который мы создали в строчке выше
      }
...
function forms(formSelector, modalTimerId) {
  ...
  const message = {
    ...
    succes: 'Спасибо! Мы скоро c вами свяжемся!',
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-06-20');
